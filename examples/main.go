...
import (
	...
	"github.com/maviance/smobilpay-go/s3p"
)
...
func main() {
	...
	fmt.Println("POST Signature:", signature)
	...
	signature2 := s3p.GenerateSignature("GET", "https://dev.smobilpay.com/s3p/v2/bill", params2, "MySecretKey")
	fmt.Println("GET Signature:", signature2)
}
